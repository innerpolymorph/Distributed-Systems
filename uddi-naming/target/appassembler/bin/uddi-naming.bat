...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="uddi-naming" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.ulisboa.tecnico.sdis.ws.uddi.UDDINamingApp %CMD_LINE_ARGS%
