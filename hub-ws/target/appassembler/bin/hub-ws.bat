...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="hub-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.hub.ws.HubApp %CMD_LINE_ARGS%
