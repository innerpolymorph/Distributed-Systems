...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="rst-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.rst.ws.cli.RestaurantClientApp %CMD_LINE_ARGS%
