...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="pts-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.pts.ws.cli.PointsClientApp %CMD_LINE_ARGS%
