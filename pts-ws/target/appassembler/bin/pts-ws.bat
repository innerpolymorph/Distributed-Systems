...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="pts-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.pts.ws.PointsApp %CMD_LINE_ARGS%
