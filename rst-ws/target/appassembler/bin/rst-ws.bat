...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="rst-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.rst.ws.RestaurantApp %CMD_LINE_ARGS%
