...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="cc-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.cc.ws.cli.CreditCardClientApp %CMD_LINE_ARGS%
