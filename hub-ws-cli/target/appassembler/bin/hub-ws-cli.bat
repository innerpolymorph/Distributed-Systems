...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="hub-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.forkexec.hub.ws.cli.HubClientApp %CMD_LINE_ARGS%
